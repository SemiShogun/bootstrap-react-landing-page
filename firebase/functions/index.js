 ...
 */
 ...
 exports.upload = functions.region('europe-west3').storage.object().onFinalize(async (object) => {
    ...
    await sharp(tempLocalFile)
        ...
        .jpeg()
        .toFile(tempLocalJPEGFile).catch(err => {
            functions.logger.error('Saving File Error', err);
        });
